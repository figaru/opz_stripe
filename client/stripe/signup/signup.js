...
Template.signup.rendered = function(){
  $('#application-signup').validate({
    ...
    submitHandler: function(){
      ...
      // on our door.
      Meteor.call("stripe.card.createToken", {
        ...
        if(err){
          ...
          $('#application-signup').append( $( "<input type='hidden' name='stripeToken' />" ).val(data.id));
          ...
          Meteor.call('stripe.customers.create', customer, function(error, response){
            if (error) {
              alert(error.reason);
